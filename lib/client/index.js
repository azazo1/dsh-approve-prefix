...
function createCard(React, primitives) {
    ...
    function PrefixRowsField(props) {
        ...
        const badges = state.overridden
            ...
            : null;
        return el('div', { className: 'field' }, el('div', { className: 'head' }, el('span', { className: 'label' }, t('column.prefix')), badges), el('p', { className: 'intro' }, t('intro')), el('div', { className: 'columns' }, el('span', { className: 'tool' }, t('column.tool')), el('span', { className: 'prefix' }, t('column.prefix')), el('span', { className: 'tail' }, '')), ...(rows.length === 0 ? [el('div', { className: 'empty' }, t('empty'))] : rows), el('div', { className: 'actions' }, el('button', {
            type: 'button',
            disabled,
